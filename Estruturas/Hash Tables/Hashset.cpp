...
Info *info = NULL; // LEMBRAAAAAAAAAAAAAAR
...
void search(hash *ht,int key) // ok
{
    int actions = 0;
...
void deleteFromHash(hash *ht, int key) // ok
{
...
void insertToHash(hash *ht, int key) //ok
{
    int actions = 0;
    int hashIndex = key % info->size;
